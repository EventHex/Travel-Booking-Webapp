    ...
    <div className="relative">
      ...
      <div className="relative">
        <select
          ...
          value={value}
          onChange={onChange}
          className={`${className} w-full py-3 px-3   text-[#B2B5C0] text-[14px] pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none`}
        >
