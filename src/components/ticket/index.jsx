...
const Ticket = ({ approvedApplication, refuntApplication, rejectedApplication }) => {
  ...
  return (
    <div className="w-full">
      <main className="w-full px-4 sm:px-6 lg:px-2 py-2">
                  ...
                  <div className="flex flex-col w-full p-3 sm:p-5">
                    <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-8 w-full">
                      ...
                      <div className="flex flex-col p-2 flex-grow">
                        ...
                        <div className="mt-4 text-[12px] sm:text-[13px] md:text-[14px] flex flex-col w-full sm:w-full md:w-[80%] lg:w-[60%] text-gray-500">
                          <div className="flex w-full">
                      ...
                      <div className="mt-4 lg:mt-0 w-full sm:w-full md:w-full lg:w-64 relative">
                      ...
                      {/* Status Card Section */}
                      <div className="mt-6 lg:mt-0 w-full sm:w-full md:w-full lg:w-72">
                        <div
