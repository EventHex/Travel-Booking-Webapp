...
import {
  ...
  import { X, ChevronRight, Clock, AlertTriangle, Headphones } from 'lucide-react';
           ...
           {showModal &&  (
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <div className="p-1.5 bg-blue-100 rounded-md mr-3">
                    <svg className="w-5 h-5 text-blue-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M18 2L21 5L14 12H11V9L18 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
              ...
              <button className="flex items-center justify-between w-full p-4 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex items-center">
                  <span className="w-6 h-6 flex items-center justify-center bg-blue-500 text-white rounded-full text-xs mr-2">2</span>
                  <ChevronRight size={20} className="text-gray-400" />
                </div>
              </button>
              ...
              <div className="bg-gray-100 rounded-lg p-4">
                <div className="flex items-start mb-2">
                  ...
                  <div>
                    <h2 className="font-bold text-gray-800">Atlys Support Hours (IST)</h2>
                    <span className="text-sm text-gray-600">Response time 2 hrs</span>
                  </div>
                </div>
              ...
              <div className="bg-gray-100 rounded-lg p-4">
                <div className="flex items-start mb-2">
                  ...
                  <div>
                    <h2 className="font-bold text-gray-800">Atlys Emergency 24x7 Hotline: <span className="text-blue-500">+91 22 48934242</span></h2>
                  </div>
                </div>
              ...
              <div className="bg-gray-100 rounded-lg p-4">
                <div className="flex items-start mb-3">
                  ...
                  <h2 className="font-bold text-gray-800">Have questions about the product?</h2>
                </div>
