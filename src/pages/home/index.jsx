            ...
            <div className="w-full flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-[60%]  px-0 md:pr-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center">
                  ...
                  <img src={Arrow}   alt="arrow" className="mt-2  hidden md:block" />
                </div>

                {/* Search Box */}
                <div className="w-full max-w-3xl mt-4 bg-gradient-to-r  p-3 sm:p-4 rounded-lg ">
                  {/* Navigation Tabs */}
                  <div className="flex justify-between md:justify-between    overflow-x-auto border-b border-[#868C98] no-scrollbar mb-4">
                    {tabs.map((tab) => (
                      <button
                        key={tab.id}
                ...
                <div>
                  <p className="text-[12px]">👍 Book with confidence. For any assistance while booking Insurance or Activities, contact us <span className="text-[#375DFB]">atb2b-assistance@atlys.com</span> </p>
                </div>
              </div>
