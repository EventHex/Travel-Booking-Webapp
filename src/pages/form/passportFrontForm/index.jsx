...
export const FrontPassportForm = () => {
  ...
  return (
    <div className="w-full mx-auto  ">
      <div className="">
        <div className="mb-6 ">
          <h1 className="text-xl p-3 md:text-2xl font-semibold text-blue-600 mb-2">
            Traveler 1
          </h1>
          <h2 className="text-lg md:text-xl p-3 font-medium text-gray-900 mb-4">
            Upload Traveler's Front Passport Page
          </h2>
          <p className="text-xs md:text-sm p-3 text-gray-600">
            ...
            <div className="flex flex-col lg:flex-row w-full gap-x-4 lg:gap-x-8 gap-y-6">
              ...
              <div className="w-full lg:w-[50%]">
                ...
                <div className="flex  justify-center gap-4">
                  <div className="mb-4  w-[30%]   flex md:mb-5">
                    <Input
                      InputClassName={"px-0"}
                      label={" Nationality"}
