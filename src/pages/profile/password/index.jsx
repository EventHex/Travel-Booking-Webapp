...
const PasswordChangeDialog = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8078/api/v1/user/update-password', {
        method: 'POST',
        headers: {
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-md relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="current-password" className="block mb-2 text-lg font-medium">
              Current Password
            </label>
            <div className="relative">
              ...
              <button
                ...
                className={`absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 rounded-full text-sm flex items-center gap-1.5 ${
                  showCurrentPassword ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 hover:bg-gray-200'
                }`}
          ...
          <div>
            <label htmlFor="new-password" className="block mb-2 text-lg font-medium">
              New Password
            </label>
            <div className="relative">
              <input
              ...
              <button
                type="button"
                className={`absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 rounded-full text-sm flex items-center gap-1.5 ${
                  showNewPassword ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 hover:bg-gray-200'
                }`}
          ...
          <div>
            <label htmlFor="confirm-password" className="block mb-2 text-lg font-medium">
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className={`absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 rounded-full text-sm flex items-center gap-1.5 ${
                  showConfirmPassword ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 hover:bg-gray-200'
                }`}
