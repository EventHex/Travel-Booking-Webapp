  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="flex border-b mb-6">
        <div 
          className={`text-2xl pb-2 mr-4 cursor-pointer ${activeTab === 'overstay' ? 'font-bold text-gray-900 border-b-2 border-gray-900' : 'font-normal text-gray-400'}`}
          onClick={() => toggleTab('overstay')}
        >
          Overstay
        </div>
        <div 
          className={`text-2xl pb-2 cursor-pointer ${activeTab === 'history' ? 'font-bold text-gray-900 border-b-2 border-gray-900' : 'font-normal text-gray-400'}`}
        ...
        <table className="min-w-full">
          <thead>
            <tr className="bg-white border-b">
              <th 
                className="px-6 py-4 text-left text-sm font-medium text-gray-900 cursor-pointer"
...
{activeTab === 'overstay' ? (
          ...
          <tbody>
            {/* Empty state */}
            <tr className="h-96">
              <td colSpan={activeTab === 'overstay' ? "7" : "5"} className="text-center">
                <div className="flex flex-col items-center justify-center p-8">
                  {activeTab === 'overstay' ? (
                    <>
                      ...
                      <p className="text-gray-500 text-lg">None of your travellers have overstayed or absconded!</p>
                    </>
                  ) : (
                    <>
                      <div className="w-40 h-40 mb-6">
                      ...
                      <p className="text-gray-500 text-lg">You do not have any history for overstay and absconding.</p>
                    </>
                  )}
                </div>
              </td>
